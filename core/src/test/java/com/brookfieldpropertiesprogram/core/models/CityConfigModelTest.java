...
class CityConfigModelTest {
    final AemContext context = BrookfieldTestContext.newAemContext();
    CityConfigModel toBeTested;

    @BeforeEach
    public void setup() throws Exception {                
        Page currentPage = context.currentPage(BrookfieldTestContext.CONFIG_C);        
        Resource currentResource = context.currentResource(BrookfieldTestContext.CONFIG_C);
        
        toBeTested =  context.currentPage().adaptTo(CityConfigModel.class);       
    }
