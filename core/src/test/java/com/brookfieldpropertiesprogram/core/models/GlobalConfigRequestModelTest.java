...
class GlobalConfigRequestModelTest {

    private final AemContext context = BrookfieldTestContext.newAemContext();

    private GlobalConfigRequestModel toBeTested;
    ...
    public void setup() throws Exception {
        ...
        toBeTested = context.currentResource().adaptTo(GlobalConfigRequestModel.class);
    ...
    @Test
    public void testGetCatchAllContactUsEmail() {
        Assertions.assertEquals("catchAllContactUsEmail@gmail.com",toBeTested.getCatchAllContactUsEmail());
    }

    @Test
    public void testGetGoogleMapsAPIKey() {
        Assertions.assertEquals("fakeGoogleMapAPIKey",toBeTested.getGoogleMapsAPIKey());
    }
