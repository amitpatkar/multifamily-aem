...
class MultiLineTitleModelTest  {
    private final AemContext context = BrookfieldTestContext.newAemContext();
    
    private MultiLineTitleModel multiLineTitleModel;
    ...
    public void setup() throws Exception {
       ...
       context.currentResource("/content/multi_model");    
        ...
        multiLineTitleModel =  context.currentResource().adaptTo(MultiLineTitleModel.class);       
    }

    @Test
    void testSiteConfigModel() throws Exception {
        // some very basic junit tests        
        assertNotNull(multiLineTitleModel);       
    }
    
     @Test
    void testGetTitle() throws Exception {
        // some very basic junit tests        
        assertNotNull(multiLineTitleModel.getTitle());       
        //System.out.println(pageInfoModel.getData());
        //assertNotNull(pageInfoModel.getData());       
    }
    
    @Test
    void testGetHtmlTitle() throws Exception {
        // some very basic junit tests        
        assertNotNull(multiLineTitleModel.getHtmlTitle());       
        //System.out.println(pageInfoModel.getData());
        //assertNotNull(pageInfoModel.getData());       
    }
