...
class PropertyConfigListModelTest {

    final AemContext context = BrookfieldTestContext.newAemContext();
    PropertyConfigListModel toBeTested;
    ...
    public void setup() throws Exception {
        ...
        toBeTested = context.currentPage().adaptTo(PropertyConfigListModel.class);
    }
    ...
    @Test
    void testGetPropertyConfigModels() throws Exception {
        // some very basic junit tests                
        Assertions.assertEquals(1,toBeTested.getPropertyConfigModels().size());
