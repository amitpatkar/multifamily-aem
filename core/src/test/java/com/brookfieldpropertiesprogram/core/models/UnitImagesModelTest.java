...
class UnitImagesModelTest {
    ...
    public void setup() throws Exception {
        ...
        context.request().setAttribute("unitTypeOrUnit", "/unit2");
        toBeTested = context.request().adaptTo(UnitImagesModel.class);
    }
