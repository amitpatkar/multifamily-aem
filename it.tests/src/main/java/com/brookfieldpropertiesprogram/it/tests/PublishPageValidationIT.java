 ...
 */
package com.brookfieldpropertiesprogram.it.tests;
...
public class PublishPageValidationIT {
    ...
    public void validateHomepage() throws ClientException, IOException, URISyntaxException {
        try (HtmlUnitClient adminPublish = cqBaseClassRule.publishRule.getAdminClient(CQClient.class).adaptTo(HtmlUnitClient.class)) {
